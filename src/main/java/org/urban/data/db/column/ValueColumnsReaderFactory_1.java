 ...
 */
public class ValueColumnsReaderFactory_1 extends ColumnReaderFactory {

    private final LinkedList<File> _files;
    
    public ValueColumnsReaderFactory_1(File directory, ObjectFilter<Integer> filter) {
    ...
    public ValueColumnsReaderFactory_1(File directory) {
