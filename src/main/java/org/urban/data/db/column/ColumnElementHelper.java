...
public final class ColumnElementHelper {
    ...
    /**
     * Convert the column counts for a column element into a string
     * representation.
     * 
     * @param element
     * @return 
     */
    public static String toArrayString(ColumnElement<IdentifiableCount> element) {
    
        return toArrayString(element.columns().toList());
    }
